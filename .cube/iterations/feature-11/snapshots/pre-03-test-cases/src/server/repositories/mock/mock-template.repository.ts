...
export class MockTemplateRepository implements TemplateRepository {
  ...
  async createRole(_templateId: string, _input: CreateTemplateRoleRequest): Promise<TemplateRolesResult | null> {
    throw new ServiceError('NOT_IMPLEMENTED', 'Template role creation skeleton is not implemented yet')
  }
  ...
  async deleteRole(_templateId: string, _roleId: string): Promise<DeleteTemplateRoleResult | null> {
    throw new ServiceError('NOT_IMPLEMENTED', 'Template role deletion skeleton is not implemented yet')
  }
