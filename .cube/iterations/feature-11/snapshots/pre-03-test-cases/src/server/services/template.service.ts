...
export class TemplateService {
  ...
  async createRole(_templateId: string, _input: CreateTemplateRoleRequest): Promise<TemplateRolesResult> {
  ...
  async deleteRole(_templateId: string, _roleId: string): Promise<DeleteTemplateRoleResult> {
