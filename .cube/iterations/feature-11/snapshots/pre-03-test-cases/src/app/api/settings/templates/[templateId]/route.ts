...
import type { ApiResponse, TemplateDetailResult, UpdateTemplateRequest } from '@/types/api'
...
export async function PATCH(
  ...
  try {
    ...
    const data = await getService().updateTemplateMeta(templateId, {} as UpdateTemplateRequest)
