...
import type { Discussion, AgentCallLog, AgentProfile, IntentResult, EventRecord, DiscussionMessage, VotePayload } from '@/types'
...
export class DiscussionService {
  ...
  private async detectAndCreateEvents(
    ...
    if (!this.eventDetector || !this.eventRateLimiter) return []
    return []
  }
